        ...
        <main className="container mx-auto px-8 py-20">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto text-center mb-16">
              <div className="bg-surface-elevated border border-primary/20 rounded-lg p-8">
                ...
                <div className="mb-6 space-y-4">
                  ...
                  <div className="text-lg">
                    <span className="text-text-secondary">or join our </span>
                    <a
                ...
                <div className="text-text-muted space-y-1">
                  <p>Email available {contacts.support.hours}</p>
                  <p>Response time: Within 24 hours</p>
                  <p>Discord: Real-time community chat</p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Personal X - First */}
                <a
                  href={contacts.social.twitter.personal.url}
                  className="flex flex-col items-center p-6 bg-surface-elevated rounded-lg hover:bg-surface-higher border border-primary/10 hover:border-primary/30 transition-all duration-200 group"
                >
                  <div className="w-12 h-12 bg-dark-primary rounded-full flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-colors">
                    <svg
                ...
                <a
                  ...
                  className="flex flex-col items-center p-6 bg-surface-elevated rounded-lg hover:bg-surface-higher border border-primary/10 hover:border-primary/30 transition-all duration-200 group"
                >
                  <div className="w-12 h-12 bg-secondary/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-secondary/30 transition-colors">
                    <svg
                  ...
                  <h3 className="font-semibold text-text-primary mb-1">Discord</h3>
                  <p className="text-sm text-text-muted text-center">
                    Community Chat
                  </p>
                </a>
                ...
                <a
                  ...
                  className="flex flex-col items-center p-6 bg-surface-elevated rounded-lg hover:bg-surface-higher border border-primary/10 hover:border-primary/30 transition-all duration-200 group"
                >
                  <div className="w-12 h-12 bg-error/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-error/30 transition-colors">
                    <svg
                  ...
                  <h3 className="font-semibold text-text-primary mb-1">YouTube</h3>
                  <p className="text-sm text-text-muted text-center">
                    Tutorials & Demos
                  </p>
                </a>
                ...
                >
                  ...
                  <h3 className="font-semibold text-text-primary mb-1">TikTok</h3>
                  <p className="text-sm text-text-muted text-center">
                    @ninjastrat
                  </p>
                </a>

                {/* Company GitHub - Sixth */}
                <a
                  href={contacts.social.github.company.url}
                  className="flex flex-col items-center p-6 bg-surface-elevated rounded-lg hover:bg-surface-higher border border-primary/10 hover:border-primary/30 transition-all duration-200 group"
                >
                  <div className="w-12 h-12 bg-muted-blue/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-muted-blue/30 transition-colors">
                    <svg
                      className="w-6 h-6 text-light-lavender"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                ...
                {/* Personal GitHub - Seventh */}
                <a
                  href={contacts.social.github.personal.url}
                  className="flex flex-col items-center p-6 bg-surface-elevated rounded-lg hover:bg-surface-higher border border-primary/10 hover:border-primary/30 transition-all duration-200 group"
                >
                  <div className="w-12 h-12 bg-muted-blue/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-muted-blue/30 transition-colors">
                    <svg
